...
export const bobBlind: Persona = {
    ...
    avatarUrl: 'https://thumbs.dreamstime.com/b/blind-man-guide-dog-icon-cartoon-style-illustration-vector-web-design-85980894.jpg',
    private: false,
    official: false,
    authorId: 'someid1',
}
...
export const danDeaf: Persona = {
    ...
    age: 32,
    description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.',
    avatarUrl: 'https://thumbs.dreamstime.com/b/deaf-male-character-ear-closeup-stop-sign-deaf-male-character-ear-closeup-sound-wave-stop-sign-isolated-cartoon-104476968.jpg',
    disability: null,
    private: true,
    official: false,
    authorId: 'someid1',
...
export const mattiMovement: Persona = {
    ...
    age: 22,
    description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.',
    avatarUrl: 'https://previews.123rf.com/images/jemastock/jemastock1805/jemastock180505112/101629762-man-in-wheelchair-cartoon-vector-illustration-graphic-design.jpg',
    disability: null,
    private: true,
    official: false,
    authorId: 'someid2',
